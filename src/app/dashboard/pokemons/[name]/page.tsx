...
import { Pokemon, PokemonsResponsive } from "@/pokemons/interfaces";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  try {
    ...
    return {
      title: "Página Pokedex",
      description:
        "Laborum ea enim anim ut amet magna consequat dolore et nisi do laboris magna aute.",
    };
  }
}
...
const getPokemon = async (name: string): Promise<Pokemon> => {
  try {
    ...
    // Si falla la petición, redirige a 404
    notFound();
    throw error; // para satisfacer a TS
  }
};
